...
Node *insert_single_child(node_type type, Node *n, int line, int col) {
...
Node *insert_double_child(node_type type, Node *n1, Node *n2, int line, int col) {
...
Node *insert_triple_child(node_type type, Node *n1, Node *n2, Node *n3, int line, int col) {
